...
angular.module('hackstack.common', [])
  ...
  .factory('hackStackUtils', function ($timeout, $window) {
    ...
    function addErrorTrigger(errorFn, errorCode, method) {
      ...
      var id = R.max(R.pluck('id', errorTriggers)) + 1 || 0;
      ...
      return function removeTrigger() {
        var myId = id;
        var removeIndex = R.findIndex(R.propEq('id', myId));
...
<<<<<<< HEAD:lib/src/hack-stack/hack-stack-utils-service.js
...
=======
    ...
    return {
      ...
      disableErrors: disableErrors,
>>>>>>> f559adc... Adding ability to add triggers to determine when an error should be thrown:lib/src/hack-stack/hack-stack-common.js
      forceError: forceError,
